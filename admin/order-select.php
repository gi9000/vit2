    ...
    <nav class="navbar navbar-default navbar-fixed">
        ...
        <div class="content">
                ...
                <table class="table table-striped table-bordered table-hover" border="1" align="center">
                    ...
                    <tbody>
                        <?php foreach($select as $se_pro): ?>
                            <tr>
                                <td><?php echo $se_pro['id_order']; ?></td>
                                <td><?php echo $se_pro['id_pro']; ?></td>
                                <td><?php echo $se_pro['username']; ?></td>
                                <td><?php echo $se_pro['number_order']; ?></td>
                                <td><?php echo $se_pro['tatol']; ?></td>
                                <td><?php echo $se_pro['status_order'] ?></td>
                                <td><a href="delete_order.php?del=<?php echo $se_pro['id_order']; ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa?');">Delete</a></td>
                                <td><a href="update_order.php?up=<?php echo $se_pro['id_order'] ?>">Update</a></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
