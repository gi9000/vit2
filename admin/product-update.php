...
if(isset($_GET['up'])) {
    $select_pro_id = $get_data->select_product_id($_GET['up']);
    foreach ($select_pro_id as $se_con) {
?>
                                        <div class="form-group">
                                            <label>Name Product</label>
                                            <input class="form-control" type="text" name="txtname"  value="<?php echo $se_con['name'] ?>">
                                            <p class="help-block">Help text here.</p>
                                        </div>
                                 <div class="form-group">
                                            <label>Number Product</label>
                                            <input class="form-control" type="number" name="txtnum"  value="<?php echo $se_con['number']?>">
                                            <p class="help-block">Help text here.</p>                                    
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="txtselect" value="<?php echo $se_con['category'] ?>">
                                                <?php
                                                $data = new data();
                                            ...
                                            <input class="form-control" type="date" name="txtdate" value="<?php echo $se_con['date'] ?>">
                                            <p class="help-block">Help text here.</p>
                                        </div><div class="form-group">
                                            <label>Price Product</label>
                                            <input class="form-control" type="number" name="txtprice" value="<?php echo $se_con['price'] ?>">
                                            <p class="help-block">Help text here.</p>
                                        </div>
                                        </div>
                                            <div class="form-group">
                                            <label>Description Product</label>
                                            <textarea class="form-control" rows="3" name=" txtdes"><?php echo $se_con['des'] ?></textarea>
                                        </div>
...
if(isset($_POST["txtsub"])) {
    $update = $get_data->update_product( $_GET['up'],
                                        $_POST['txtname'],
                                        $_POST['txtnum'],
                                        $_FILES['txtpic']['name'],
                                        $_POST['txtselect'],
    ...
    if($update) {
       ...
       window.location= 'productselect.php'</script>";   
    } else {
